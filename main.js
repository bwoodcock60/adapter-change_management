 ...
 */
function isHibernating(response, callback) {
...
function processRequestResults(error, response, body, callback) {
   ...
   */
   ...
   var testHibernate = isHibernating(response, callback);
   //console.log(testHibernate);
   if(testHibernate){
       console.log(`Log: Service Now instance is hibernating`)
       error = 'Service Now instance is hibernating';
   }else{
       console.log(`\nService Now instance running`);
   }
